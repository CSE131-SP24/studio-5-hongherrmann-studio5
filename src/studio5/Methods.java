...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		Color bblue = new Color(0, 109, 219);
		StdDraw.setPenColor(bblue);
		StdDraw.filledCircle(x, y, (3.0/4.0) * radius);
		

		// Red ring with 1.0/2.0 the radius
		// suggested rgb values: 146, 0, 0
		Color rred = new Color(146, 0, 0);
		StdDraw.setPenColor(rred);
		StdDraw.filledCircle(x, y, (1.0/2.0) * radius);
		

		// Yellow ring with 1.0/4.0 the radius
		// suggested rgb values: 255, 255, 109
		Color yyellow = new Color(255, 255, 109);
		StdDraw.setPenColor(yyellow);
	...
	public static String substituteAll(String source, char target, String replacement) {
		...
		for (int i=0; i<n; i++)
		{
			String a = source.substring(i,i+1);
			if (a.equals(target)) {
				result += replacement;
			}
			else {
